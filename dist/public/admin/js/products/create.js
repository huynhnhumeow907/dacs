...
const btnNewVariant = async () => {
  ...
  btn.addEventListener("click", () => {
    ...
    tr.innerHTML = `<td class="mx-auto h-full my-auto"><sl-switch class="mx-auto block" checked="" size="medium" form="" data-optional="" data-valid=""></sl-switch></td><td><sl-select class="w-[10rem] mx-auto" clearable="" name="color" size="medium" placement="bottom" form="" data-optional="" data-valid=""><small>Màu sắc</small><sl-option value="678627c1396ca015d58aa65f" role="option" aria-selected="false" aria-disabled="false"><div class="flex justify-between items-center"> <sl-icon class="mr-[10px]" slot="prefix" name="palette" aria-hidden="true" library="default"></sl-icon><div>đỏ</div><div class="ml-auto w-[20px]"><sl-color-picker format="hex" size="small" label="Mã màu" name="code" value="#e30d18" disabled="" form="" data-optional="" data-valid=""> </sl-color-picker></div></div></sl-option></sl-select></td><td><sl-select class="w-[10rem] mx-auto" clearable="" name="size" size="medium" placement="bottom" form="" data-optional="" data-valid=""><small>Kích thước</small><sl-option value="67862cb724e1760b15b700be" role="option" aria-selected="false" aria-disabled="false"><sl-icon slot="prefix" name="rulers" aria-hidden="true" library="default"></sl-icon>L<sl-icon slot="suffix" name="patch-check" aria-hidden="true" library="default"></sl-icon></sl-option><sl-option value="67862d0824e1760b15b700dd" role="option" aria-selected="false" aria-disabled="false"><sl-icon slot="prefix" name="rulers" aria-hidden="true" library="default"></sl-icon>M<sl-icon slot="suffix" name="patch-check" aria-hidden="true" library="default"></sl-icon></sl-option><sl-option value="67862d1224e1760b15b700fa" role="option" aria-selected="false" aria-disabled="false"><sl-icon slot="prefix" name="rulers" aria-hidden="true" library="default"></sl-icon>F<sl-icon slot="suffix" name="patch-check" aria-hidden="true" library="default"></sl-icon></sl-option></sl-select></td><td><div class="format-number-overview flex gap-x-[10px] items-center justify-center mx-auto"><sl-input class="w-[7rem] text-center " type="number" name="price" size="medium" form="" data-optional="" data-valid=""></sl-input></div></td><td><div class="mx-auto"><sl-input class="w-[7rem] text-center mx-auto" type="number" value="0" discount="" max="100" maxlength="2" name="discount" size="medium" form="" data-optional="" data-valid=""></sl-input></div></td><td><div class="flex items-center w-max justify-center mx-auto"> <sl-format-number></sl-format-number><div class="đ">đ</div></div></td><td><sl-input class="w-[7rem] mx-auto" type="number" value="0" name="quantity" size="medium" form="" data-optional="" data-valid=""></sl-input></td><td><sl-icon class="cursor-pointer text-[red]" slot="suffix" name="trash" aria-hidden="true" library="default"></sl-icon></td>`;
